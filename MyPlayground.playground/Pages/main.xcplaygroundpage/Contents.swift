...
*/
func isGreater(farg:Int, sarg: Int) -> String{
    switch a>b{
    case true:
        return "yep"
    default:
...
isInRange(farg:0) // prints "small"
isInRange(farg:99) // prints "not sure"
isInRange(farg:5) // prints "big"
