...
func isForce (with name: String) -> Bool {
    switch name{
    case "Luke", "Lei", "Anakin", "Obi Wan", "Yoda", "Vader" :
        return true
    default:
        return false
    }
    
//    let peopleWithForce = ["Luke", "Lei", "Anakin", "Obi Wan", "Yoda", "Vader"]
//    for i in peopleWithForce{
//        switch i == name {
//        case true:
//            print(true)
//        case false:
...
isInRange(number: 0) // prints "small"
isInRange(number: 99) // prints "not sure"
isInRange(number: 5) // prints "big"
