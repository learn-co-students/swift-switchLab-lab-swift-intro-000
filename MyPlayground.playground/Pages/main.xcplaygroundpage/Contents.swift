...
func isForce(with name: String) -> Bool {
    switch true {
        case name == "Luke": return true
        case name == "Leia": return true
        case name == "Anakin": return true
        case name == "Obi Wan": return true
        case name == "Yoda": return true
        case name == "Vader": return true
