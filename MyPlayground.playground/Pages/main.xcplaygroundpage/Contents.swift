...
func isForce(with: String) -> Bool {
    switch with=="Luke" || with=="Leia" || with=="Anakin" || with=="Obi Wan" || with=="Yoda" || with=="Vader" {
    case true:
        return true
    default:
        return false
...
isInRange(a: 0) // prints "small"
isInRange(a: 99) // prints "not sure"
isInRange(a: 5) // prints "big"
