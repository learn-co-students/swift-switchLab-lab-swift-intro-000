...
// If it has a decimal point, then it's a Double, if it's just a single number, it's an Int.
/*: Question 1
...
isInRange(0)
isInRange(99)
isInRange(5) // Shouldn't this be "medium" since it's between 4 and 6?
